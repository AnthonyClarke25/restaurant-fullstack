                    ...
                    <div class="card-body">
                        <form action="#" id="basicform" data-parsley-validate="" novalidate="">
                            <div class="form-group">
                                ...
                                <input id="inputCategory" type="text" name="category" data-parsley-trigger="change" required=""
                            ...
                            <div class="form-group">
                                ...
                                <input id="inputCategoryImageUrl" type="text" name="image_url" data-parsley-trigger="change" required=""
                                    placeholder="https://www.billys.com/img/burgers.jpeg" autocomplete="off" class="form-control">
                            </div>
